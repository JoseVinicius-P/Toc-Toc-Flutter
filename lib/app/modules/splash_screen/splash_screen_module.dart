import 'package:toctoc/app/modules/splash_screen/notification_guard_service.dart';
...
class SplashScreenModule extends Module {
  ...
  final List<Bind> binds = [
    Bind.lazySingleton((i) => NotificationGuardService()),
  ...
  final List<ModularRoute> routes = [
    ChildRoute('/', child: (_, args) => SplashScreenPage(), guards: [AuthGuardService()/*, NotificationGuardService()*/]),
  ];
